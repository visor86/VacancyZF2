...
class Languages extends \Application\Entity\Languages implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Application\\Entity\\Languages' . "\0" . 'languageId', '' . "\0" . 'Application\\Entity\\Languages' . "\0" . 'title', '' . "\0" . 'Application\\Entity\\Languages' . "\0" . 'descriptions', '' . "\0" . 'Application\\Entity\\Languages' . "\0" . 'vacancies');
        }
